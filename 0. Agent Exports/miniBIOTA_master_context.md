...
- Archived Operation Living Intelligence Wave 9 material is provenance only. Financials owner approval is still required before any finance read, aggregate definition, generated output, spend, recommendation, or canonical writeback.
## Financial Baseline
...
- **2026-05-18:** Operation Living Intelligence Wave 6/9 Financials provenance was archived under `archive/superseded/operation-living-intelligence/`. The archived records preserve no-spend media/model planning and sensitive-domain policy history only. Financials approval is still required before any finance read, aggregate definition, runway/cash/cost/liability label, helper, generated output, spend, recommendation, or canonical writeback.
...
- May AmEx activity is reviewed from current activity but should wait for the
  ...
  reconciliation.
- Archived Operation Living Intelligence Wave 9 material is provenance only; raw Financials records, account details, statements, liabilities, cash, tax, documents, spend, commitments, and finance recommendations remain owner-approval gated before any projection or generated output.
...
| File | Contents |
|---|---|
| `M:\miniBIOTA\miniBIOTA_Company\archive\superseded\operation-living-intelligence\` | Archived Operation Living Intelligence Wave provenance for Financials; not active operating instructions |
...
- **2026-05-18:** Operation Living Intelligence Wave 2/6 Content and media-visual-AI provenance was archived under `archive/superseded/operation-living-intelligence/`. The archived records preserve candidate story-graph, Lake Post-Seal packet, visual-AI media-set, and no-write App proposal history only; the active Content path is now the Intelligent Harness observation workflow and owner-reviewed Content production planning. No content calendar, pipeline, script, caption, media metadata, publication, public copy, App runtime, Planner/Supabase write, or canonical writeback is authorized by the archived wave material.
...
## Recent Milestones
- 2026-05-18: Operation Living Intelligence Wave 8 Hardware provenance was archived under `archive/superseded/operation-living-intelligence/`. The archived records preserve telemetry-summary design and domain-review routing history only. Hardware live-control, firmware, MQTT publishing, command queues, telemetry schema, producer services, live telemetry reads, generated output, helpers, and canonical writeback remain unapproved unless separately scoped.
...
- Archived Operation Living Intelligence Wave 8 material is provenance only; Hardware-owned telemetry/control changes remain separately approval gated.
...
| File | Contents |
|---|---|
| `M:\miniBIOTA\miniBIOTA_Company\archive\superseded\operation-living-intelligence\` | Archived Operation Living Intelligence Wave provenance for Hardware; not active operating instructions |
| `memory\00-index.md` | Memory file routing and local playbook routing |
...
- Archived Operation Living Intelligence Wave 9 material is provenance only. Growth owner approval is still required before CRM/partner reads, relationship summaries, outreach recommendations, sponsor/pricing/campaign implications, public claims, or generated output.
## Key Facts
...
- Archived Operation Living Intelligence Wave 9 material must not turn public intake, newsletter/signup, donation/support, event, or conversion surfaces into CRM, Growth, Financials, or agent-memory output without separate Web/Growth approval and privacy rules.
...
- 2026-05-18: Operation Living Intelligence Wave 8/9 Web provenance was archived under `archive/superseded/operation-living-intelligence/`. The archived records preserve telemetry-summary and sensitive-domain public-intake policy history only. Web/Growth approval is still required before any public-intake read, CRM linkage, public aggregate output, route/form behavior, newsletter sync, public copy, public claim, telemetry runtime change, or canonical writeback.
...
- 2026-05-18: Operation Living Intelligence Wave 1/2 Web provenance was archived under `archive/superseded/operation-living-intelligence/`. Candidate public reuse and story-graph sidecar material remains review-gated only; it does not authorize Web route behavior, species-card copy, chronicle output, ecosystem-map relationships, public messaging, database records, schema, Planner records, telemetry behavior, or launch/announcement work.
...
- Archived Operation Living Intelligence Wave 8 material is provenance only; Web telemetry/public-summary changes remain separately approval gated.
- Archived Operation Living Intelligence Wave 9 material is provenance only; public intake, CRM linkage, financial/growth projection, and public claims remain Web/Growth approval gated.
...
- **Company:** Archived Operation Living Intelligence Wave 8/9 material is provenance only; Web-facing telemetry or public-intake reuse requires separate Web/Growth approval.
...
| File | Contents |
|---|---|
| `M:\miniBIOTA\miniBIOTA_Company\archive\superseded\operation-living-intelligence\` | Archived Operation Living Intelligence Wave provenance for Web; not active operating instructions |
...
- Active tabs: Planner, Financials, CRM, Roadmap, Prompt Library, Site Admin, Ecology Events, and Monitoring. Former top-level Weekly Checklist and Tasks behavior has been consolidated into Planner.
- App owns CRM as software/runtime/schema/UI implementation. Growth owns CRM
  relationship meaning, lifecycle strategy, follow-up rules, opportunity
  context, and commercial commitment discipline.
...
- Ecology Events is now a top-level internal read-only App tab. It uses the Electron main-process secret-key REST bridge to browse the live `ecological_events` layer and its source/species/biome/story-thread/open-loop links without adding RLS policies or public reads.
...
- **2026-05-18:** Operation Living Intelligence Wave 1-9 App/Company provenance was archived under `archive/superseded/operation-living-intelligence/`. The active App brief now keeps only the current Intelligent Harness path and a compact archive pointer; the detailed wave-era readbacks remain available for audit/provenance only.
...
- Ecological events tables are live with internal App read access only through the main-process secret-key bridge. Public/runtime RLS policy design, public display, Memgraph projection, event editing, and additional seed batches remain separate approvals.
...
- Prompt Library schema is live after migration 012, but create/edit/copy/archive flows still need interactive app smoke verification before daily reliance.
- Operation Living Intelligence Wave 1-9 outputs are archived provenance only. They preserve local graph/readback, retrieval, visual-AI/media, Planner-routing, telemetry, and sensitive-domain proof history, but the active App-facing path is now the Intelligent Harness observation workflow.
- Intelligent Harness outputs remain local/suggestion-only unless separately approved. Supabase/Planner writes, Memgraph or pgvector changes, Media Library metadata writes, public output, approve/reject/correct actions, App runtime behavior changes, and canonical writeback remain blocked by default.
- The new full OLI Memgraph projection is a derived local readback layer, not canonical truth. It may support Content relationship/context questions after approved observation writes, but Content must continue to rely on canonical Supabase rows for source truth and must not treat graph paths as approval for story links, open loop links, beats, chronicles, media metadata, Planner work, public output, or writeback.
## Cross-Domain Notes
...
- **Ecosystem/Data:** Species and chronicle admin changes in the app affect public ecology records. Field Observer sighting counts/details should remain history datapoints; curated species population fields remain manually maintained. Ecology Events is now the internal QA/browser surface for the dated ecological-event layer before broader backfill, public access, or graph projection.
...
| `M:\miniBIOTA\miniBIOTA_Company\archive\superseded\operation-living-intelligence\` | Archived Wave 1-9 Operation Living Intelligence provenance and deferred-lane records; not active App operating instructions |
| `M:\miniBIOTA\miniBIOTA_App\fixtures\operation_living_intelligence\intelligent_harness\` | Current local Intelligent Harness fixture/input path for App-side suggestion-run workflows |
| `M:\miniBIOTA\miniBIOTA_App\out\operation_living_intelligence\intelligent_harness\` | Current ignored local Intelligent Harness readback/output path; suggestion-only unless separately approved |
