...
- **App:** Internal ecological-event browsing is now live and has passed QA through Marine Shore packet 07. Packet 08 is live and needs App QA next. Continue using the browser to QA broader event backfill before public RLS policies, website display, event editing, or Memgraph projection.
