...
- 2026-05-14: A screenshot-driven `/live-monitoring` mobile sensor-card polish pass was implemented under Planner task `507`; node cards now have an equal-height layout treatment and mobile metric values stay together. The task remains open pending owner screenshot review.
