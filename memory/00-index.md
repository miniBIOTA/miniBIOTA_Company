...
15. Read `memory/23-phase-11-dependency-risk-closeout-2026-05-10.md` when the task needs the Phase 11 YouTube import replacement route or the safe Planner/Supabase current-status read path.
...
| `23-phase-11-dependency-risk-closeout-2026-05-10.md` | Phase 11 dependency risk closeout for YouTube import routing and safe Planner/Supabase current-status reads |
