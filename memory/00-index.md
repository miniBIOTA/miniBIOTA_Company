...
Operation Living Intelligence is closed as an active Company planning program as of 2026-05-19. OLI derived-layer awareness remains provenance for future reopened work: `_system/database_awareness.md`, `skills/coordinate-cross-domain-priorities/reference/operation-living-intelligence-plan.md`, `skills/coordinate-cross-domain-priorities/reference/operation-living-intelligence-data-projection-matrix.md`, and archived files under `archive/superseded/operation-living-intelligence/`. Memgraph and the Company local vector helper are noncanonical helper patterns, not sources of truth. Supabase `vector` extension is enabled as of 2026-05-19, but OpenAI/API-key-dependent pgvector embedding was rejected after cost/credential review; no pgvector tables, embedding rows, indexes, refresh jobs, App runtime integration, or public search are approved. Graph and vector layers are helpers for finding context and must be verified against Markdown, Supabase, domain source docs, or approved source records before consequential use.
...
Current open Company work projects:
...
Closed Company work project:
- `Operation Living Intelligence Coordination` (closed 2026-05-19; archive/provenance only unless explicitly reopened)
...
| `skills/coordinate-cross-domain-priorities/reference/operation-living-intelligence-plan.md` | Archived/provenance Operation Living Intelligence data-stack plan for Markdown, Supabase, graph, vector, analytics warehouse, visual AI, cache, automation, and agent routing coordination |
| `skills/coordinate-cross-domain-priorities/reference/operation-living-intelligence-data-projection-matrix.md` | Archived/provenance Operation Living Intelligence source-to-derived-layer projection matrix for Supabase, Memgraph, retrieval/vector options, analytics, telemetry, media, Planner, CRM, Financials, and agent routing |
