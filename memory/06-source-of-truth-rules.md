...
## Brain Mirrors
Do not edit Brain mirrored docs directly. Brain mirrors are historical/reference artifacts for this repo after the Company restructure, not active workflow authorities. Do not sync mirrors unless explicitly scoped.
