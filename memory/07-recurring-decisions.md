...
- Visual AI and local model workflows are part of Operation Living Intelligence planning. Raw media should stay local by default, visual model outputs are candidate annotations until reviewed, and models such as Qwen2.5-VL-7B should be treated as time-sensitive candidates rather than permanent commitments.
