...
- Brain company brief when manager-facing strategy state, priorities, risks, planning gaps, or dependencies matter.
...
6. Review Programs/Operations governance: decision boundary, owner, durable source of truth, and whether the work belongs to Company, a domain, Brain, App, or Planner.
...
8. Identify whether Brain company brief, domain briefs, domain repos, Company memory, or structured records need follow-up.
...
- Brain, domain, App, Planner, or structured-record implications.
